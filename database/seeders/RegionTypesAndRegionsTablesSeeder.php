...
class RegionTypesAndRegionsTablesSeeder extends Seeder
{
    /**
        ...
        try {
            ...
            foreach ($countries as $country) {
                $region = Region::create([
                    ...
                    'alpha2Code' => trim($country['alpha2Code']),
                    'alpha3Code' => trim($country['alpha3Code']),
                    'numberCode' => '+' . trim($country['numberCode']),
                    'type_id' => 1,
                ]);
    ...
    public function countries()
    {
        ...
        return json_decode($countries, true)['countries'];
    }
}